...
| `TB_CHECK_NAME`                                                              | Names the GitHub pull request check `TestingBot / <name>` (`iOS`, `Android`) so separate jobs on one commit post separate checks (`--check-name`, CLI 1.4.0+).   |
